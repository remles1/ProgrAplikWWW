    ...
    <div class="main">
        <?php
            ...
            if (isset($_POST['change_ilosc_produktu'])) {
                $ilosc_prod = $_SESSION['koszyk']->lista_prod[$_POST['produkt_id']];
                $_SESSION['koszyk']->lista_prod[$_POST['produkt_id']] = 0;
                $_SESSION['koszyk']->changeIloscProduktu($_POST['produkt_id'],$_POST['ilosc_produktu']);
            }
        ?>
