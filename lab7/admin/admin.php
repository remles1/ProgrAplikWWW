...
<?php
    ...
    if (!isset($_SESSION['auth'])) {
        $_SESSION['auth'] = false; // Default to false if not set
    }
    ...
    function EdytujPodstrone(){
        ...
        if(isset($_POST['submit_edit'])){
            ...
            $query = "UPDATE page_list SET page_title='$page_title', page_content='$page_content', alias='$alias', status='$active' WHERE id='$id'";
